...
- Add sample reports. Status: implemented under `samples/`.
- Add privacy and safety documentation. Status: implemented with `docs/privacy-and-support-bundles.md` and existing safety docs.
- Tag `v0.1.0`.
